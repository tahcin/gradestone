...
### Scarcity and Choice
At the heart of microeconomics is the concept of scarcity—the fundamental economic problem that arises because people have unlimited wants but resources are limited.
...
5. **Budget Share**
   - Larger portion of budget → more elastic
...
1. **Time Horizon**
   - Momentary supply (immediate) → least elastic
   - Short-run supply → moderately elastic
   - Long-run supply → most elastic

2. **Resource Mobility**
   - Easier to reallocate resources → more elastic

3. **Excess Capacity**
   - More unused capacity → more elastic

4. **Inventory Levels**
   - Larger inventories → more elastic

5. **Production Technology**
   - Flexibility in production methods → more elastic
...
- Price decrease → effective income increases → consumption typically increases
- Price increase → effective income decreases → consumption typically decreases
